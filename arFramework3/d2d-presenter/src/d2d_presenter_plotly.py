"""The d2d_presenter application for use with plotly.js.

This leads to a faster and cleaner code since plotly.js supports scientific
data natively, but also to more performance issues on client side.

ATTENTION: As of now, this version does not work with simplejson installed.
"""
