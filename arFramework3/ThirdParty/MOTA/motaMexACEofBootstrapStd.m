function [xsorts,phiBoot,phiBootStd]=motaMexACEofBootstrapStd(x,NumOfBootSamp,SampleSize) 
...
dim=length(x(:,1))-1;
    ...
    phiBoot=zeros(dim+1,SampleSize,NumOfBootSamp);
    ...
    phiBootStd = std(phiBoot,0,3);
    phiBoot = mean(phiBoot,3);
end
