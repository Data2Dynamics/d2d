% This function checks, which parameters have to be reoptimized if
% parameter p_name is fixed to p_val
% An L1-penalty is set to ar.p

function result = arIdentifiablityTest_WhichP(p_name,p_val)
global ar
