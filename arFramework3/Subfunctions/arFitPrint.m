...
elseif abs(round(ar.config.optimizer)-ar.config.optimizer)>1e-10  % no index
    arFprintf(1, 'ar.config.optimizer=%d finished after %i iterations: %s, total improvement = %g\n', ...
        ar.config.optimizer, ...
