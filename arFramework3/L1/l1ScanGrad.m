%% DEPRECATED
% l1ScanGrad(jks, [linv], [gradient], [lks], [OptimizerSteps])
% 
% Deprecated version of the major function for performing an L1 scan.
% 
...
function l1ScanGrad(jks, linv, gradient)
