...
if trd_orig > 0 && trd_l1 == 0
    ...
    '        mtxmpy,pcmtx,pcoptions,tol,kmax,theta,l(dofit),u(dofit),z,dnewt,preconflag,ind_L1,grplas_grps,ind_grplas,varargin{:});\n',...
    'else\n',...
    ...
    '   mtxmpy,pcmtx,pcoptions,tol,kmax,theta,l,u,Z,dnewt,preconflag,ind_L1,grplas_grps,ind_grplas,varargin)\n']);
