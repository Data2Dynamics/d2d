...
% arLoadExtraData(name, [m], [extension], [removeEmptyObs], [mixingCond], [fieldsvar], [opts])
%
...
function arLoadExtraData(name, m, extension, removeEmptyObs, mixingCond, fieldsvar, varargin)
