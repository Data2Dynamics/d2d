#include "AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1.h"
...
#include <arInputFunctionsC.h>
 ...
 void fu_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(void *user_data, double t)
{
 ...
 void fsu_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(void *user_data, double t)
{
 ...
 void fv_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(realtype t, N_Vector x, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 void dvdx_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(realtype t, N_Vector x, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 void dvdu_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(realtype t, N_Vector x, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 void dvdp_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(realtype t, N_Vector x, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 int fx_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(realtype t, N_Vector x, N_Vector xdot, void *user_data)
{
  UserData data = (UserData) user_data;
  int is;
  ...
  fu_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(data, t);
  fv_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(t, x, data);
  xdot_tmp[0] = v[0];
  xdot_tmp[1] = v[1];
  xdot_tmp[2] = v[2];
  xdot_tmp[3] = v[3];
 ...
 void fxdouble_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(realtype t, N_Vector x, double *xdot_tmp, void *user_data)
{
  int is;
  UserData data = (UserData) user_data;
  double *p = data->p;
 ...
 void fx0_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(N_Vector x0, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 int dfxdx_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(long int N, realtype t, N_Vector x, 
  	...
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
  ...
  dvdx_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(t, x, data);
  for (is=0; is<121; is++) {
    J->data[is] = 0.0;
  }
  J->data[1] = dvdx[1];
 ...
 int dfxdx_out_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(realtype t, N_Vector x, realtype* J, void *user_data) {
  int is;
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 int dfxdx_sparse_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(realtype t, N_Vector x, 
  	...
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
 ...
 int fsx_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(int Ns, realtype t, N_Vector x, N_Vector xdot, 
  	...
  	N_Vector tmp1, N_Vector tmp2)
{
  ...
  fsu_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(data, t);
  dvdx_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(t, x, data);
  dvdu_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(t, x, data);
  dvdp_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(t, x, data);
  for (is=0; is<11; is++) {
    sv[is] = 0.0;
  }
 ...
 int subfsx_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(int Ns, realtype t, N_Vector x, N_Vector xdot, 
  	int ip, N_Vector sx, N_Vector sxdot, void *user_data, 
  	N_Vector tmp1, N_Vector tmp2)
 {
   UserData data = (UserData) user_data;
   return fsx_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(Ns, t, x, xdot, data->sensIndices[ip], sx, sxdot, user_data, tmp1, tmp2);
 };

 void csv_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(realtype t, N_Vector x, int ip, N_Vector sx, void *user_data)
{
  int is;
  UserData data = (UserData) user_data;
  double *p = data->p;
 ...
 void fsx0_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(int ip, N_Vector sx0, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 void subfsx0_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(int ip, N_Vector sx0, void *user_data)
 {
   UserData data = (UserData) user_data;
   fsx0_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(data->sensIndices[ip], sx0, user_data);
 };

 void dfxdp0_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(realtype t, N_Vector x, double *dfxdp0, void *user_data)
{
  int is;
  UserData data = (UserData) user_data;
  double *p = data->p;
 ...
 void dfxdp_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(realtype t, N_Vector x, double *dfxdp, void *user_data)
{
  int is;
  UserData data = (UserData) user_data;
  double *p = data->p;
 ...
 void fz_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(double t, int nt, int it, int nz, int nx, int nu, int iruns, double *z, double *p, double *u, double *x){
 ...
 void fsz_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(double t, int nt, int it, int np, double *sz, double *p, double *u, double *x, double *z, double *su, double *sx){
  int jp;
  for (jp=0; jp<np; jp++) {
 ...
 void dfzdx_AktPathwayFujita_A9B39DA920ACACCF8E12C30D2F3744E1(double t, int nt, int it, int nz, int nx, int nu, int iruns, double *dfzdxs, double *z, double *p, double *u, double *x){
