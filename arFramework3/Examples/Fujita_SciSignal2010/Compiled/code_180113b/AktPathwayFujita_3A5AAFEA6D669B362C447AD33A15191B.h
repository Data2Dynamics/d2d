#ifndef _MY_AktPathwayFujita_3A5AAFEA6D669B362C447AD33A15191B
#define _MY_AktPathwayFujita_3A5AAFEA6D669B362C447AD33A15191B
...
#include <arInputFunctionsC.h>
 ...
 int dfxdx_AktPathwayFujita_3A5AAFEA6D669B362C447AD33A15191B(long int N, realtype t, N_Vector x,N_Vector fx, DlsMat J, void *user_data,N_Vector tmp1, N_Vector tmp2, N_Vector tmp3);
 int dfxdx_out_AktPathwayFujita_3A5AAFEA6D669B362C447AD33A15191B(realtype t, N_Vector x, realtype* J, void *user_data); int dfxdx_sparse_AktPathwayFujita_3A5AAFEA6D669B362C447AD33A15191B(realtype t, N_Vector x,N_Vector fx, SlsMat J, void *user_data,N_Vector tmp1, N_Vector tmp2, N_Vector tmp3);
 int fsx_AktPathwayFujita_3A5AAFEA6D669B362C447AD33A15191B(int Ns, realtype t, N_Vector x, N_Vector xdot,int ip, N_Vector sx, N_Vector sxdot, void *user_data,N_Vector tmp1, N_Vector tmp2);
 int subfsx_AktPathwayFujita_3A5AAFEA6D669B362C447AD33A15191B(int Ns, realtype t, N_Vector x, N_Vector xdot,int ip, N_Vector sx, N_Vector sxdot, void *user_data,N_Vector tmp1, N_Vector tmp2);
...
#endif /* _MY_AktPathwayFujita_3A5AAFEA6D669B362C447AD33A15191B */
