#ifndef _MY_model_AktPathwayFujita_727DD824F350367B8ABC8B349AADFABE
#define _MY_model_AktPathwayFujita_727DD824F350367B8ABC8B349AADFABE
...
#include <arInputFunctionsC.h>
 ...
 int dfxdx_model_AktPathwayFujita_727DD824F350367B8ABC8B349AADFABE(long int N, realtype t, N_Vector x,N_Vector fx, DlsMat J, void *user_data,N_Vector tmp1, N_Vector tmp2, N_Vector tmp3);
 int dfxdx_out_model_AktPathwayFujita_727DD824F350367B8ABC8B349AADFABE(realtype t, N_Vector x, realtype* J, void *user_data); int dfxdx_sparse_model_AktPathwayFujita_727DD824F350367B8ABC8B349AADFABE(realtype t, N_Vector x,N_Vector fx, SlsMat J, void *user_data,N_Vector tmp1, N_Vector tmp2, N_Vector tmp3);
 int fsx_model_AktPathwayFujita_727DD824F350367B8ABC8B349AADFABE(int Ns, realtype t, N_Vector x, N_Vector xdot,int ip, N_Vector sx, N_Vector sxdot, void *user_data,N_Vector tmp1, N_Vector tmp2);
 int subfsx_model_AktPathwayFujita_727DD824F350367B8ABC8B349AADFABE(int Ns, realtype t, N_Vector x, N_Vector xdot,int ip, N_Vector sx, N_Vector sxdot, void *user_data,N_Vector tmp1, N_Vector tmp2);
...
#endif /* _MY_model_AktPathwayFujita_727DD824F350367B8ABC8B349AADFABE */
