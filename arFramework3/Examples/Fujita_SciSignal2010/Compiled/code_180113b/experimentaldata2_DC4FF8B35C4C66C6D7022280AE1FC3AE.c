#include "experimentaldata2_DC4FF8B35C4C66C6D7022280AE1FC3AE.h"
...
#include <arInputFunctionsC.h>
 ...
 void fy_experimentaldata2_DC4FF8B35C4C66C6D7022280AE1FC3AE(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y, double *p, double *u, double *x, double *z){
 ...
 void fystd_experimentaldata2_DC4FF8B35C4C66C6D7022280AE1FC3AE(double t, int nt, int it, int ntlink, int itlink, double *ystd, double *y, double *p, double *u, double *x, double *z){
  ystd[it+nt*0] = p[17];
  ystd[it+nt*1] = p[16];
  ystd[it+nt*2] = p[18];
 ...
 void fsy_experimentaldata2_DC4FF8B35C4C66C6D7022280AE1FC3AE(double t, int nt, int it, int ntlink, int itlink, double *sy, double *p, double *u, double *x, double *z, double *su, double *sx, double *sz){
 ...
 void fsystd_experimentaldata2_DC4FF8B35C4C66C6D7022280AE1FC3AE(double t, int nt, int it, int ntlink, int itlink, double *systd, double *p, double *y, double *u, double *x, double *z, double *sy, double *su, double *sx, double *sz){
  systd[it+nt*49] = 1.0;
  systd[it+nt*51] = 1.0;
  systd[it+nt*56] = 1.0;
 ...
 void fy_scale_experimentaldata2_DC4FF8B35C4C66C6D7022280AE1FC3AE(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y_scale, double *p, double *u, double *x, double *z, double *dfzdx){
