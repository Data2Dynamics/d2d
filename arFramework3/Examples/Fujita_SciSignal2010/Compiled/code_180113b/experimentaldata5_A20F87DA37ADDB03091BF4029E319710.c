#include "experimentaldata5_A20F87DA37ADDB03091BF4029E319710.h"
...
#include <arInputFunctionsC.h>
 ...
 void fy_experimentaldata5_A20F87DA37ADDB03091BF4029E319710(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y, double *p, double *u, double *x, double *z){
 ...
 void fystd_experimentaldata5_A20F87DA37ADDB03091BF4029E319710(double t, int nt, int it, int ntlink, int itlink, double *ystd, double *y, double *p, double *u, double *x, double *z){
  ystd[it+nt*0] = p[18];
  ystd[it+nt*1] = p[17];
  ystd[it+nt*2] = p[19];
 ...
 void fsy_experimentaldata5_A20F87DA37ADDB03091BF4029E319710(double t, int nt, int it, int ntlink, int itlink, double *sy, double *p, double *u, double *x, double *z, double *su, double *sx, double *sz){
 ...
 void fsystd_experimentaldata5_A20F87DA37ADDB03091BF4029E319710(double t, int nt, int it, int ntlink, int itlink, double *systd, double *p, double *y, double *u, double *x, double *z, double *sy, double *su, double *sx, double *sz){
  systd[it+nt*52] = 1.0;
  systd[it+nt*54] = 1.0;
  systd[it+nt*59] = 1.0;
 ...
 void fy_scale_experimentaldata5_A20F87DA37ADDB03091BF4029E319710(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y_scale, double *p, double *u, double *x, double *z, double *dfzdx){
