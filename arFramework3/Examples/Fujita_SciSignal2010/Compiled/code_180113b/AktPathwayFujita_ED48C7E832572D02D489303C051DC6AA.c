#include "AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA.h"
 ...
 int fx_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(realtype t, N_Vector x, N_Vector xdot, void *user_data)
{
  ...
  fu_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(data, t);
  fv_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(t, x, data);
  xdot_tmp[0] = v[0];
  xdot_tmp[1] = v[1];
  xdot_tmp[2] = v[2];
  xdot_tmp[3] = v[3];
 ...
 void fx0_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(N_Vector x0, void *user_data)
{
 ...
 int dfxdx_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(long int N, realtype t, N_Vector x, 
  	...
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
  ...
  dvdx_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(t, x, data);
  for (is=0; is<100; is++) {
    J->data[is] = 0.0;
  }
  J->data[1] = dvdx[1];
 ...
 int dfxdx_out_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(realtype t, N_Vector x, realtype* J, void *user_data) {
  int is;
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 int dfxdx_sparse_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(realtype t, N_Vector x, 
  	...
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
 ...
 int fsx_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(int Ns, realtype t, N_Vector x, N_Vector xdot, 
  	...
  	N_Vector tmp1, N_Vector tmp2)
{
  ...
  fsu_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(data, t);
  dvdx_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(t, x, data);
  dvdu_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(t, x, data);
  dvdp_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(t, x, data);
  for (is=0; is<10; is++) {
    sv[is] = 0.0;
  }
 ...
 int subfsx_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(int Ns, realtype t, N_Vector x, N_Vector xdot, 
  	int ip, N_Vector sx, N_Vector sxdot, void *user_data, 
  	N_Vector tmp1, N_Vector tmp2)
 {
   UserData data = (UserData) user_data;
   return fsx_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(Ns, t, x, xdot, data->sensIndices[ip], sx, sxdot, user_data, tmp1, tmp2);
 };
 ...
 void fsx0_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(int ip, N_Vector sx0, void *user_data)
{
 ...
 {
   UserData data = (UserData) user_data;
   fsx0_AktPathwayFujita_ED48C7E832572D02D489303C051DC6AA(data->sensIndices[ip], sx0, user_data);
 };
