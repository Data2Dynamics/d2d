#include "experimentaldata2_63F31091FF14435C5AD1DC30930D8C9D.h"
...
#include <arInputFunctionsC.h>
 ...
 void fy_experimentaldata2_63F31091FF14435C5AD1DC30930D8C9D(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y, double *p, double *u, double *x, double *z){
 ...
 void fystd_experimentaldata2_63F31091FF14435C5AD1DC30930D8C9D(double t, int nt, int it, int ntlink, int itlink, double *ystd, double *y, double *p, double *u, double *x, double *z){
  ystd[it+nt*0] = p[19];
  ystd[it+nt*1] = p[18];
  ystd[it+nt*2] = p[20];
 ...
 void fsy_experimentaldata2_63F31091FF14435C5AD1DC30930D8C9D(double t, int nt, int it, int ntlink, int itlink, double *sy, double *p, double *u, double *x, double *z, double *su, double *sx, double *sz){
 ...
 void fsystd_experimentaldata2_63F31091FF14435C5AD1DC30930D8C9D(double t, int nt, int it, int ntlink, int itlink, double *systd, double *p, double *y, double *u, double *x, double *z, double *sy, double *su, double *sx, double *sz){
  systd[it+nt*55] = 1.0;
  systd[it+nt*57] = 1.0;
  systd[it+nt*62] = 1.0;
 ...
 void fy_scale_experimentaldata2_63F31091FF14435C5AD1DC30930D8C9D(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y_scale, double *p, double *u, double *x, double *z, double *dfzdx){
