#include "AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA.h"
...
#include <arInputFunctionsC.h>
 ...
 void fu_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(void *user_data, double t)
{
 ...
 void fsu_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(void *user_data, double t)
{
 ...
 void fv_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(realtype t, N_Vector x, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
  ...
  data->v[10] = 8.333333333333333E-4;

  return;
}


 void dvdx_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(realtype t, N_Vector x, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 void dvdu_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(realtype t, N_Vector x, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 void dvdp_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(realtype t, N_Vector x, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 int fx_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(realtype t, N_Vector x, N_Vector xdot, void *user_data)
{
  UserData data = (UserData) user_data;
  int is;
  ...
  fu_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(data, t);
  fv_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(t, x, data);
  xdot_tmp[0] = v[0];
  xdot_tmp[1] = v[1];
  xdot_tmp[2] = v[2];
  xdot_tmp[3] = v[3];
 ...
 void fxdouble_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(realtype t, N_Vector x, double *xdot_tmp, void *user_data)
{
  int is;
  UserData data = (UserData) user_data;
  double *p = data->p;
 ...
 void fx0_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(N_Vector x0, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 int dfxdx_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(long int N, realtype t, N_Vector x, 
  	...
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
  ...
  dvdx_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(t, x, data);
  for (is=0; is<121; is++) {
    J->data[is] = 0.0;
  }
  J->data[1] = dvdx[1];
 ...
 int dfxdx_out_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(realtype t, N_Vector x, realtype* J, void *user_data) {
  int is;
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 int dfxdx_sparse_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(realtype t, N_Vector x, 
  	...
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
 ...
 int fsx_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(int Ns, realtype t, N_Vector x, N_Vector xdot, 
  	...
  	N_Vector tmp1, N_Vector tmp2)
{
  ...
  fsu_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(data, t);
  dvdx_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(t, x, data);
  dvdu_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(t, x, data);
  dvdp_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(t, x, data);
  for (is=0; is<11; is++) {
    sv[is] = 0.0;
  }
 ...
 int subfsx_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(int Ns, realtype t, N_Vector x, N_Vector xdot, 
  	int ip, N_Vector sx, N_Vector sxdot, void *user_data, 
  	N_Vector tmp1, N_Vector tmp2)
 {
   UserData data = (UserData) user_data;
   return fsx_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(Ns, t, x, xdot, data->sensIndices[ip], sx, sxdot, user_data, tmp1, tmp2);
 };

 void csv_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(realtype t, N_Vector x, int ip, N_Vector sx, void *user_data)
{
  int is;
  UserData data = (UserData) user_data;
  double *p = data->p;
 ...
 void fsx0_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(int ip, N_Vector sx0, void *user_data)
{
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 void subfsx0_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(int ip, N_Vector sx0, void *user_data)
 {
   UserData data = (UserData) user_data;
   fsx0_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(data->sensIndices[ip], sx0, user_data);
 };

 void dfxdp0_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(realtype t, N_Vector x, double *dfxdp0, void *user_data)
{
  int is;
  UserData data = (UserData) user_data;
  double *p = data->p;
 ...
 void dfxdp_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(realtype t, N_Vector x, double *dfxdp, void *user_data)
{
  int is;
  UserData data = (UserData) user_data;
  double *p = data->p;
 ...
 void fz_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(double t, int nt, int it, int nz, int nx, int nu, int iruns, double *z, double *p, double *u, double *x){
 ...
 void fsz_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(double t, int nt, int it, int np, double *sz, double *p, double *u, double *x, double *z, double *su, double *sx){
  int jp;
  for (jp=0; jp<np; jp++) {
 ...
 void dfzdx_AktPathwayFujita_D0F88C7601ECDBB0816C4D415614FFFA(double t, int nt, int it, int nz, int nx, int nu, int iruns, double *dfzdxs, double *z, double *p, double *u, double *x){
