#include "experimentaldata4_6985107BAF3F1F7BAF9ED21C47F6AFBA.h"
...
#include <arInputFunctionsC.h>
 ...
 void fy_experimentaldata4_6985107BAF3F1F7BAF9ED21C47F6AFBA(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y, double *p, double *u, double *x, double *z){
 ...
 void fystd_experimentaldata4_6985107BAF3F1F7BAF9ED21C47F6AFBA(double t, int nt, int it, int ntlink, int itlink, double *ystd, double *y, double *p, double *u, double *x, double *z){
  ystd[it+nt*0] = p[17];
  ystd[it+nt*1] = p[16];
  ystd[it+nt*2] = p[18];
 ...
 void fsy_experimentaldata4_6985107BAF3F1F7BAF9ED21C47F6AFBA(double t, int nt, int it, int ntlink, int itlink, double *sy, double *p, double *u, double *x, double *z, double *su, double *sx, double *sz){
 ...
 void fsystd_experimentaldata4_6985107BAF3F1F7BAF9ED21C47F6AFBA(double t, int nt, int it, int ntlink, int itlink, double *systd, double *p, double *y, double *u, double *x, double *z, double *sy, double *su, double *sx, double *sz){
  systd[it+nt*49] = 1.0;
  systd[it+nt*51] = 1.0;
  systd[it+nt*56] = 1.0;
 ...
 void fy_scale_experimentaldata4_6985107BAF3F1F7BAF9ED21C47F6AFBA(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y_scale, double *p, double *u, double *x, double *z, double *dfzdx){
