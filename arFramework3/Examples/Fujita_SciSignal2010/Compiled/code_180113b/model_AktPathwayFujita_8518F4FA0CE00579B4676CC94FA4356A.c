 ...
 void fv_model_AktPathwayFujita_8518F4FA0CE00579B4676CC94FA4356A(realtype t, N_Vector x, void *user_data)
{
  ...
  data->v[0] = p[4]*x_tmp[0]*3.0E1-p[5]*x_tmp[8];
 ...
 void fx0_model_AktPathwayFujita_8518F4FA0CE00579B4676CC94FA4356A(N_Vector x0, void *user_data)
{
 ...
 int dfxdx_model_AktPathwayFujita_8518F4FA0CE00579B4676CC94FA4356A(long int N, realtype t, N_Vector x, 
  	...
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
 ...
 int dfxdx_out_model_AktPathwayFujita_8518F4FA0CE00579B4676CC94FA4356A(realtype t, N_Vector x, realtype* J, void *user_data) {
  int is;
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 int dfxdx_sparse_model_AktPathwayFujita_8518F4FA0CE00579B4676CC94FA4356A(realtype t, N_Vector x, 
  	...
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
 ...
 int fsx_model_AktPathwayFujita_8518F4FA0CE00579B4676CC94FA4356A(int Ns, realtype t, N_Vector x, N_Vector xdot, 
  	...
  	N_Vector tmp1, N_Vector tmp2)
{
  ...
  fsu_model_AktPathwayFujita_8518F4FA0CE00579B4676CC94FA4356A(data, t);
  dvdx_model_AktPathwayFujita_8518F4FA0CE00579B4676CC94FA4356A(t, x, data);
 ...
 int subfsx_model_AktPathwayFujita_8518F4FA0CE00579B4676CC94FA4356A(int Ns, realtype t, N_Vector x, N_Vector xdot, 
  	int ip, N_Vector sx, N_Vector sxdot, void *user_data, 
  	N_Vector tmp1, N_Vector tmp2)
 {
   UserData data = (UserData) user_data;
   return fsx_model_AktPathwayFujita_8518F4FA0CE00579B4676CC94FA4356A(Ns, t, x, xdot, data->sensIndices[ip], sx, sxdot, user_data, tmp1, tmp2);
 };
 ...
 void fsx0_model_AktPathwayFujita_8518F4FA0CE00579B4676CC94FA4356A(int ip, N_Vector sx0, void *user_data)
{
 ...
 {
   UserData data = (UserData) user_data;
   fsx0_model_AktPathwayFujita_8518F4FA0CE00579B4676CC94FA4356A(data->sensIndices[ip], sx0, user_data);
 };
