#include "AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD.h"
 ...
 int fx_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(realtype t, N_Vector x, N_Vector xdot, void *user_data)
{
  ...
  fu_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(data, t);
  fv_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(t, x, data);
  xdot_tmp[0] = v[0];
  xdot_tmp[1] = v[1];
  xdot_tmp[2] = v[2];
  xdot_tmp[3] = v[3];
 ...
 void fx0_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(N_Vector x0, void *user_data)
{
 ...
 int dfxdx_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(long int N, realtype t, N_Vector x, 
  	...
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
  ...
  dvdx_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(t, x, data);
  for (is=0; is<81; is++) {
    J->data[is] = 0.0;
  }
  J->data[0] = dvdx[0];
 ...
 int dfxdx_out_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(realtype t, N_Vector x, realtype* J, void *user_data) {
  int is;
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 int dfxdx_sparse_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(realtype t, N_Vector x, 
  	...
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
 ...
 int fsx_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(int Ns, realtype t, N_Vector x, N_Vector xdot, 
  	...
  	N_Vector tmp1, N_Vector tmp2)
{
  ...
  fsu_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(data, t);
  dvdx_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(t, x, data);
  dvdu_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(t, x, data);
  dvdp_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(t, x, data);
  for (is=0; is<9; is++) {
    sv[is] = 0.0;
  }
 ...
 int subfsx_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(int Ns, realtype t, N_Vector x, N_Vector xdot, 
  	int ip, N_Vector sx, N_Vector sxdot, void *user_data, 
  	N_Vector tmp1, N_Vector tmp2)
 {
   UserData data = (UserData) user_data;
   return fsx_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(Ns, t, x, xdot, data->sensIndices[ip], sx, sxdot, user_data, tmp1, tmp2);
 };
 ...
 void fsx0_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(int ip, N_Vector sx0, void *user_data)
{
 ...
 {
   UserData data = (UserData) user_data;
   fsx0_AktPathwayFujita_149EC7FEC258A3323A8AB7CA73F87AAD(data->sensIndices[ip], sx0, user_data);
 };
