#include "experimentaldata5_51A5493E5BE30FE0DBC3F2A65978962E.h"
...
#include <arInputFunctionsC.h>
 ...
 void fy_experimentaldata5_51A5493E5BE30FE0DBC3F2A65978962E(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y, double *p, double *u, double *x, double *z){
 ...
 void fystd_experimentaldata5_51A5493E5BE30FE0DBC3F2A65978962E(double t, int nt, int it, int ntlink, int itlink, double *ystd, double *y, double *p, double *u, double *x, double *z){
  ystd[it+nt*0] = p[20];
  ystd[it+nt*1] = p[19];
  ystd[it+nt*2] = p[21];
 ...
 void fsy_experimentaldata5_51A5493E5BE30FE0DBC3F2A65978962E(double t, int nt, int it, int ntlink, int itlink, double *sy, double *p, double *u, double *x, double *z, double *su, double *sx, double *sz){
 ...
 void fsystd_experimentaldata5_51A5493E5BE30FE0DBC3F2A65978962E(double t, int nt, int it, int ntlink, int itlink, double *systd, double *p, double *y, double *u, double *x, double *z, double *sy, double *su, double *sx, double *sz){
  systd[it+nt*58] = 1.0;
  systd[it+nt*60] = 1.0;
  systd[it+nt*65] = 1.0;
 ...
 void fy_scale_experimentaldata5_51A5493E5BE30FE0DBC3F2A65978962E(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y_scale, double *p, double *u, double *x, double *z, double *dfzdx){
