...
if ( sum( ismember( ar.model.x, {'stateA', 'stateD', 'stateF', 'stateH', 'stateI', 'stateJ', 'stateL', 'stateO', 'stateR', 'stateS', 'stateT', 'stateW', 'NESTER2', 'NESTEE3', 'stateZ', 'stateAfterComment', 'stateCommentA', 'stateCommentB' } ) ) == 18 ) 
    fprintf( 'PASSED\n' );
else
    error( 'FAILED\n');
end
