...
% model subspace M1 (no annihilation of x1 and x2, i.e. k3=0)
...
petsModelSpace.(ar.pLabel{3})(1) = "0"; 

% model subspace M2 (estimate annihilation rate k3)
petsModelSpace.model_subspace_id(2) = "M2";
petsModelSpace.model_subspace_petab_yaml(2) = petabFile;
petsModelSpace.(ar.pLabel{1})(2) = "0;0.2;estimate"; 
petsModelSpace.(ar.pLabel{2})(2) = "0;0.1;estimate"; 
petsModelSpace.(ar.pLabel{3})(2) = "estimate";
