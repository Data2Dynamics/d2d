...
arSetPars('injection1_timepoint', 30, 2, 0, 0, 10);     % first injection time point, here at 40 min
...
arSetPars('wash_timepoint', 50, 2, 0, 0, 10);           % washing time point, here at 40 min
...
arSetPars('injection2_timepoint', 60, 2, 0, 0, 10);     % second injection time point, here at 40 min
