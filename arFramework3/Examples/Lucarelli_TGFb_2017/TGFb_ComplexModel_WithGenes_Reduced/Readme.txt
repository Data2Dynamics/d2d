Original folder name: /dsk/home/ck96/2013_TGFb/21_Patientendaten2 
Date: 13-Jun-2017 
...
#   8|D  | geneA_act1          |       -5       -1.8         +3 | 1     +0.014 |       1 | uniform(-5,3) 
#   9|D  | geneA_act2          |       -5       -3.1         +3 | 1    +0.0008 |       1 | uniform(-5,3) 
#  10|D  | geneA_act3          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
     |   |                     |                                |              |         |      
#  11|D  | geneA_inh1          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  12|D  | geneA_inh2          |       -5       -1.3         +3 | 1     +0.046 |       1 | uniform(-5,3) 
#  13|D  | geneA_inh3          |       -5       -1.6         +3 | 1     +0.026 |       1 | uniform(-5,3) 
#  14|D  | geneA_turn          |       -5       -2.3         +3 | 1    +0.0046 |       1 | uniform(-5,3) 
#  15|D  | geneB_act1          |       -5      -0.34         +3 | 1      +0.46 |       1 | uniform(-5,3) 
#  16|D  | geneB_act2          |       -5       -1.1         +3 | 1     +0.074 |       1 | uniform(-5,3) 
#  17|D  | geneB_act3          |       -5       -1.5         +3 | 1      +0.03 |       1 | uniform(-5,3) 
#  18|D  | geneB_inh1          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  19|D  | geneB_inh2          |       -5      -0.13         +3 | 1      +0.75 |       1 | uniform(-5,3) 
...
#  23|D  | geneC_act2          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  24|D  | geneC_act3          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  25|D  | geneC_inh1          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  26|D  | geneC_inh2          |       -5       -1.7         +3 | 1     +0.018 |       1 | uniform(-5,3) 
#  27|D  | geneC_inh3          |       -5       -1.5         +3 | 1     +0.035 |       1 | uniform(-5,3) 
...
#  30|D  | geneD_act2          |       -5       -3.6         +3 | 1   +0.00027 |       1 | uniform(-5,3) 
     |   |                     |                                |              |         |      
#  31|D  | geneD_act3          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  32|D  | geneD_inh1          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
...
#  36|D  | geneE_act1          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  37|D  | geneE_act2          |       -5     +0.014         +3 | 1         +1 |       1 | uniform(-5,3) 
#  38|D  | geneE_act3          |       -5      +0.78         +3 | 1       +6.1 |       1 | uniform(-5,3) 
#  39|D  | geneE_inh1          |       -5      +0.91         +3 | 1       +8.2 |       1 | uniform(-5,3) 
#  40|D  | geneE_inh2          |       -5      +0.16         +3 | 1       +1.4 |       1 | uniform(-5,3) 
     |   |                     |                                |              |         |      
#  41|D  | geneE_inh3          |       -5      +0.98         +3 | 1       +9.7 |       1 | uniform(-5,3) 
#  42|D  | geneE_turn          |       -5      -0.91         +3 | 1      +0.12 |       1 | uniform(-5,3) 
#  43|D  | geneF_act1          |       -5         +3         +3 | 1     +1e+03 |       1 | uniform(-5,3) 
#  44|D  | geneF_act2          |       -5      -0.88         +3 | 1      +0.13 |       1 | uniform(-5,3) 
#  45|D  | geneF_act3          |       -5       +1.3         +3 | 1        +21 |       1 | uniform(-5,3) 
#  46|D  | geneF_inh1          |       -5      +0.56         +3 | 1       +3.6 |       1 | uniform(-5,3) 
#  47|D  | geneF_inh2          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  48|D  | geneF_inh3          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  49|D  | geneF_turn          |       -5       +1.6         +3 | 1        +37 |       1 | uniform(-5,3) 
#  50|D  | geneG_act1          |       -5       +2.8         +3 | 1   +6.2e+02 |       1 | uniform(-5,3) 
     |   |                     |                                |              |         |      
#  51|D  | geneG_act2          |       -5       +1.7         +3 | 1        +56 |       1 | uniform(-5,3) 
#  52|D  | geneG_act3          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  53|D  | geneG_inh1          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  54|D  | geneG_inh2          |       -5       -1.8         +3 | 1     +0.018 |       1 | uniform(-5,3) 
#  55|D  | geneG_inh3          |       -5       -3.1         +3 | 1   +0.00082 |       1 | uniform(-5,3) 
#  56|D  | geneG_turn          |       -5       +2.5         +3 | 1   +2.9e+02 |       1 | uniform(-5,3) 
#  57|D  | geneH_act1          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
...
#  63|D  | geneH_turn          |       -5    -0.0029         +3 | 1      +0.99 |       1 | uniform(-5,3) 
#  64|D  | geneI_act1          |       -5      +0.97         +3 | 1       +9.3 |       1 | uniform(-5,3) 
#  65|D  | geneI_act2          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  66|D  | geneI_act3          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  67|D  | geneI_inh1          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
...
#  70|D  | geneI_turn          |       -5       -2.5         +3 | 1    +0.0033 |       1 | uniform(-5,3) 
     |   |                     |                                |              |         |      
#  71|D  | geneJ_act1          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  72|D  | geneJ_act2          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  73|D  | geneJ_act3          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  74|D  | geneJ_inh1          |       -5      -0.32         +3 | 1      +0.48 |       1 | uniform(-5,3) 
#  75|D  | geneJ_inh2          |       -5         -2         +3 | 1    +0.0099 |       1 | uniform(-5,3) 
#  76|D  | geneJ_inh3          |       -5       -2.1         +3 | 1    +0.0085 |       1 | uniform(-5,3) 
#  77|D  | geneJ_turn          |       -5       -1.9         +3 | 1     +0.014 |       1 | uniform(-5,3) 
#  78|D  | geneK_act1          |       -5       -1.9         +3 | 1     +0.013 |       1 | uniform(-5,3) 
#  79|D  | geneK_act2          |       -5       -3.5         +3 | 1   +0.00028 |       1 | uniform(-5,3) 
#  80|D  | geneK_act3          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
     |   |                     |                                |              |         |      
#  81|D  | geneK_inh1          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  82|D  | geneK_inh2          |       -5      +0.14         +3 | 1       +1.4 |       1 | uniform(-5,3) 
#  83|D  | geneK_inh3          |       -5      +0.39         +3 | 1       +2.4 |       1 | uniform(-5,3) 
#  84|D  | geneK_turn          |       -5       -2.4         +3 | 1    +0.0036 |       1 | uniform(-5,3) 
#  85|D  | geneL_act1          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  86|D  | geneL_act2          |       -5       -3.3         +3 | 1   +0.00047 |       1 | uniform(-5,3) 
#  87|D  | geneL_act3          |       +0         +0     +1e+03 | 0         +0 |       0 | uniform(0,1000) 
#  88|D  | geneL_inh1          |       -5      +0.11         +3 | 1       +1.3 |       1 | uniform(-5,3) 
#  89|D  | geneL_inh2          |       -5       -1.2         +3 | 1     +0.062 |       1 | uniform(-5,3) 
#  90|D  | geneL_inh3          |       -5      -0.87         +3 | 1      +0.13 |       1 | uniform(-5,3) 
     |   |                     |                                |              |         |      
...
# 108|  E| sd_Dnmt3a_nExpID100 |       -5         -1         +3 | 1     +0.096 |       1 | uniform(-5,3) 
# 109|  E| sd_Dusp5_nExpID100  |       -5      -0.98         +3 | 1       +0.1 |       1 | uniform(-5,3) 
# 110|  E| sd_Jun_nExpID100    |       -5      -0.79         +3 | 1      +0.16 |       1 | uniform(-5,3) 
     |   |                     |                                |              |         |      
# 111|  E| sd_Klf10_nExpID100  |       -5      -0.93         +3 | 1      +0.12 |       1 | uniform(-5,3) 
# 112|  E| sd_Pdk4_nExpID100   |       -5       -1.1         +3 | 1     +0.073 |       1 | uniform(-5,3) 
...
This is a reduced TGFb complex model with genes after selection the important complexes and after fixing non-required parameters to zero.
