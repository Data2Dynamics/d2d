#ifndef _MY_RTF_DoseDependent_F298A94C5A6864FEB754E83604898892
#define _MY_RTF_DoseDependent_F298A94C5A6864FEB754E83604898892
...
#include <arInputFunctionsC.h>
 ...
 int dfxdx_RTF_DoseDependent_F298A94C5A6864FEB754E83604898892(long int N, realtype t, N_Vector x,N_Vector fx, DlsMat J, void *user_data,N_Vector tmp1, N_Vector tmp2, N_Vector tmp3);
 int dfxdx_out_RTF_DoseDependent_F298A94C5A6864FEB754E83604898892(realtype t, N_Vector x, realtype* J, void *user_data); int dfxdx_sparse_RTF_DoseDependent_F298A94C5A6864FEB754E83604898892(realtype t, N_Vector x,N_Vector fx, SlsMat J, void *user_data,N_Vector tmp1, N_Vector tmp2, N_Vector tmp3);
 int fsx_RTF_DoseDependent_F298A94C5A6864FEB754E83604898892(int Ns, realtype t, N_Vector x, N_Vector xdot,int ip, N_Vector sx, N_Vector sxdot, void *user_data,N_Vector tmp1, N_Vector tmp2);
 int subfsx_RTF_DoseDependent_F298A94C5A6864FEB754E83604898892(int Ns, realtype t, N_Vector x, N_Vector xdot,int ip, N_Vector sx, N_Vector sxdot, void *user_data,N_Vector tmp1, N_Vector tmp2);
...
#endif /* _MY_RTF_DoseDependent_F298A94C5A6864FEB754E83604898892 */
