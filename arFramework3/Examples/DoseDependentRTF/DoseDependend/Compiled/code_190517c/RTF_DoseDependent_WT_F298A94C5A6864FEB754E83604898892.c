 ...
 void fx0_RTF_DoseDependent_WT_F298A94C5A6864FEB754E83604898892(N_Vector x0, void *user_data)
{
 ...
 int dfxdx_RTF_DoseDependent_WT_F298A94C5A6864FEB754E83604898892(long int N, realtype t, N_Vector x, 
  	...
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
 ...
 int dfxdx_out_RTF_DoseDependent_WT_F298A94C5A6864FEB754E83604898892(realtype t, N_Vector x, realtype* J, void *user_data) {
  int is;
  UserData data = (UserData) user_data;
  double *p = data->p;
  double *u = data->u;
 ...
 int dfxdx_sparse_RTF_DoseDependent_WT_F298A94C5A6864FEB754E83604898892(realtype t, N_Vector x, 
  	...
  	N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
 ...
 int fsx_RTF_DoseDependent_WT_F298A94C5A6864FEB754E83604898892(int Ns, realtype t, N_Vector x, N_Vector xdot, 
  	...
  	N_Vector tmp1, N_Vector tmp2)
{
  ...
  fsu_RTF_DoseDependent_WT_F298A94C5A6864FEB754E83604898892(data, t);
  dvdx_RTF_DoseDependent_WT_F298A94C5A6864FEB754E83604898892(t, x, data);
 ...
 int subfsx_RTF_DoseDependent_WT_F298A94C5A6864FEB754E83604898892(int Ns, realtype t, N_Vector x, N_Vector xdot, 
  	int ip, N_Vector sx, N_Vector sxdot, void *user_data, 
  	N_Vector tmp1, N_Vector tmp2)
 {
   UserData data = (UserData) user_data;
   return fsx_RTF_DoseDependent_WT_F298A94C5A6864FEB754E83604898892(Ns, t, x, xdot, data->sensIndices[ip], sx, sxdot, user_data, tmp1, tmp2);
 };
 ...
 void fsx0_RTF_DoseDependent_WT_F298A94C5A6864FEB754E83604898892(int ip, N_Vector sx0, void *user_data)
{
 ...
 {
   UserData data = (UserData) user_data;
   fsx0_RTF_DoseDependent_WT_F298A94C5A6864FEB754E83604898892(data->sensIndices[ip], sx0, user_data);
 };
